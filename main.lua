...
local DeltaLib = {}
function DeltaLib:Notify(NotifyConfig)
    local NotifyConfig = NotifyConfig or {}
    NotifyConfig.Title = NotifyConfig.Title or "ducsharelink Hub"
...
function DeltaLib:Start(GuiConfig)
    local GuiConfig = GuiConfig or {}
    GuiConfig.Name = GuiConfig.Name or "ducsharelink Hub"
    ...
    GuiConfig["Logo Info"] = GuiConfig["Logo Info"] or "rbxassetid://18861408627"
	GuiConfig["Avatar Dev"] = GuiConfig["Avatar Dev"] or "https://www.roblox.com/headshot-thumbnail/image?userId="..game:GetService("Players").LocalPlayer.UserId .."&width=420&height=420&format=png"
	GuiConfig["Name Info"] = GuiConfig["Name Info"] or "ducsharelink Hub Info"
    GuiConfig["Name Dev"] = GuiConfig["Name Dev"] or tostring(game:GetService("Players").LocalPlayer.Name)
    ...
    function DeltaLib:ToggleUI()
        Main.Visible = not Main.Visible
    end
    function DeltaLib:CloseUI()
        DeltaGui:Destroy()
    end
    ...
    LogTitle.Text = GuiConfig["Name Dev"]
    ...
    LogoInfo.Image = GuiConfig["Avatar Dev"]
    ...
    function Tabs:MakeTab(NameTab)
        ...
        function Sections:Section(SectionConfig)
            ...
            function Items:Dropdown(DropdownConfig)
                ...
                DropdownConfig["Place Holder Text"] = DropdownConfig["Place Holder Text"] or "Select Options"
