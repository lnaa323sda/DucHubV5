--[[
   ___               ___          _                       
   /   \_   _  ___   /   \___  ___(_) __ _ _ __   ___ _ __ 
  / /\ / | | |/ __| / /\ / _ \/ __| |/ _` | '_ \ / _ \ '__|
 / /_//| |_| | |__ / /_//  __/\__ \ | |_| | | | |  __/ |   
/___,'  \__,_|\___/___,' \___||___/_|\__, |_| |_|\___|_|   
                                     |___/ 
]]--                                     
-- Chuyên bẻ khóa mã nguồn và fix cực ez .
-- Nhận làm và bán mã nguồn giá rẻ .
-- Có dịch vụ cày thuê và bán acc giá siêu múp .

========================================================== Thằng nào kid lại thì đổi name hộ tao =================================================================================
...
local Tabs = {
    Main = Window:AddTab({ Title = "Mục Main", Icon = "mbm" }),
    Stats = Window:AddTab({ Title = "Mục Sub", Icon = "mbm" }),
    Info = Window:AddTab({ Title = "Mục Status", Icon = "mbm" }),
    Seaev = Window:AddTab({ Title = "Mục Sea Event", Icon = "mbm" }),
    Player = Window:AddTab({ Title = "Mục Player", Icon = "mbm" }),
    Teleport = Window:AddTab({ Title = "Mục Teleport", Icon = "mbm" }),
    Fruit = Window:AddTab({ Title = "Mục Blox Fruits", Icon = "mbm" }),
    Raid = Window:AddTab({ Title = "Mục Raids", Icon = "mbm" }),
    Race = Window:AddTab({ Title = "Mục Race Trial", Icon = "mbm" }),
    Shop = Window:AddTab({ Title = "Mục Shop", Icon = "mbm" }),
    Misc = Window:AddTab({ Title = "Mục Misc", Icon = "mbm" }),
    Hop = Window:AddTab({ Title = "Mục Server", Icon = "mbm" }),
    Setting = Window:AddTab({ Title = "Mục Settings", Icon = "mbm" }),
    Fluent = Window:AddTab({ Title = "Mục Config", Icon = "mbm" }),
}
...
if id == 2753915549 then First_Sea = true; elseif id == 4442272183 then Second_Sea = true; elseif id == 7449423635 then Third_Sea = true; else game.Players.LocalPlayer:Kick("Check script here : box zalo") end;
-- anti
function AntiBan()
...
print("made by minh duc & dakii")
    print("Xin chào đã đến với FREE FIRE HUB")
    print("UwU")
    print("boing boing")
    print("ty for using - have fun")
    print("Mời các bạn mukbang script")
    print("wait ,.,")
    print("LCTSV - .,.")  
...
local listfastattack = {'0.25','0.2','0.15','0.1','0.05','0.02','0.015','0.01','0'}
    ...
    spawn(function()
        ...
        --------------------------------------------------------------------------------------------------------------------------------------------
        local ToggleMobAura = Tabs.Main:AddToggle("ToggleMobAura", {Title = "Report Bug in My Zalo ⚠ (video)", Description = "báo lỗi ở Zalo + video", Default = false })
...
--------------------------------------------------------------------------------------------------------------------------------------------
    Tabs.Main:AddButton({
        Title = "config auto chest in box zalo click to join",
        Description = "lấy script auto chest trong box zalo ấn để tham gia",
        Callback = function()
            setclipboard("https://zalo.me/g/cxtjdz698")
        end
    })
...
----------------------------------------------------------------------------------------------------------------------------------------------
    ...
    Tabs.Main:AddParagraph({
        ...
        Content = "--------------------------------------------\njoin my zalo to get some private server free!"
    })
    Tabs.Main:AddButton({
        Title = "Unlock Fps",
