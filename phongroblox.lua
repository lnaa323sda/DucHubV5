...
ImageButton.Image = "http://www.roblox.com/asset/?id=128588876458320"
...
require(game.ReplicatedStorage.Notification).new("<Color=Blue>" Mau đăng kí kênh cho tao "<Color=/>"):Display()
require(game.ReplicatedStorage.Notification).new("<Color=Blue>" Dit me chúng mày "<Color=/>"):Display()
...
Tabs.infor:AddButton({
        Title = "Discord | Phong Roblox",
        Description = "Copy Link",
        Callback = function()
        setclipboard("https://discord.gg/9j66gSs7Bv")
        end
    })
---------------TabStatus
